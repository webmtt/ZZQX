<template>
<Modal class="InsertPhone"  :mask-closable="false"  :closable="false" :z-index="10" width="610px" v-model="show" :title="title">
    <Form ref="pointReportForm" inline :model="formModel" v-if="show" :label-width="100" :rules="ruleValidate">
        <FormItem class="InsertPhoneInputs" label="站点名称" prop="stationName">
        ...
        <FormItem class="InsertPhoneInputss" label="站点编号" prop="stationCode">
            <Input size="small" disabled v-model="formModel.stationCode" placeholder="站点编号" style="width: 160px" />
        </FormItem>
        <!--<FormItem class="InsertPhoneInputs" label="作业方式" prop="workType">
        ...
        <FormItem class="InsertPhoneInputs" label="装备类型" prop="equipmentType">
