    ...
    <div ref="workResult" class="workResult" style="padding: 10px 10px 0 10px;background: #FFF;">
        <div style="background: #1D2437;color: #FFFFFF;padding: 10px;font-size: 13px;">
          <div style="display: inline-block;">
            <Icon @click="returnPage" style="margin-right: 3px;" type="ios-arrow-back" />作业情况上报
          </div>
        ...
        <i-form :model="serachCondtion" ref="searchPart" inline :label-width="80">
            <div style="height: 45px;margin-top: 17px;"><span  style="color: black;font-size: 13px;">站点名称：</span>
            <Form-item class="workResultPhone" prop="name" style="margin-bottom:5px;position: absolute;left: 3px;top: 59px;">
                <i-input type="text" style="width: 238px;" v-model="serachCondtion.name" placeholder="站点名称"></i-input>
            </Form-item></div>
            <div style="height: 45px;"><span  style="color: black;font-size: 13px;">开始时间：</span>
            <Form-item class="workResultPhone" style="margin-bottom:5px;position: absolute;left: 3px;top: 105px;">
                <DatePicker @on-change="startTimeRangeChange" :options="options1" type="datetime" placeholder="选择作业开始时间" style="width: 245px;"></DatePicker>
            </Form-item></div>
            <div style="height: 45px;"><span  style="color: black;font-size: 13px;">结束时间：</span>
            <Form-item class="workResultPhone" style="margin-bottom:10px;position: absolute;left: 3px;top: 150px;">
                <DatePicker @on-change="endTimeRangeChange" :options="options2" type="datetime" placeholder="选择作业结束时间" style="width: 245px;"></DatePicker>
            </Form-item></div>
...
import workResultSubmit from '@/components/addOrUpdateWorkResultPhone';
