<template>
    <Modal width="670" :mask-closable="false" :closable="false" :z-index="10" v-model="show" :title="editMode ==='insert' ? '新增作业效果' : '编辑作业效果'">
        ...
        data () {
            ...
            return {
                ...
                ruleValidate: {
                    ...
                    taskType: [{ required: true, message: '作业类型不能为空', trigger: 'change' }],
